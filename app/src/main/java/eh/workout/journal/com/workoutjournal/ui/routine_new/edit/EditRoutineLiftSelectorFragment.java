...
public class EditRoutineLiftSelectorFragment extends Fragment {
    public EditRoutineLiftSelectorFragment() {
    }

    public static EditRoutineLiftSelectorFragment newInstance() {
        return new EditRoutineLiftSelectorFragment();
    }
