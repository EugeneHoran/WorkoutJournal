...
public class CaldroidBottomSheetFragment extends BottomSheetDialogFragment {
    /**
     * Weekday conventions
     */
    public static int
    ...
    private int themeResource = com.caldroid.R.style.CaldroidDefault;
    ...
    protected void retrieveInitialArgs() {
        ...
        if (args != null) {
            ...
            // Get theme
            themeResource = args.getInt(THEME_RESOURCE, com.caldroid.R.style.CaldroidDefault);
        }
        if (month == -1 || year == -1) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = localInflater.inflate(com.caldroid.R.layout.calendar_view, container, false);
